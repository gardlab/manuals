...
* Document your time and activities in the lab using the following google sheets link. Please make sure to click 'Add Sheet' on the bottom left corner, rename it using your name, and use the formatting as indicated on the first page. This file is located in the Gard Lab All Box in the RA -> Timesheets folder. https://docs.google.com/spreadsheets/d/1v_W8PDKy_3BNvl0mo_p_Zr9fjqCvF7HKzI_pg4-fows/edit#gid=455141679
